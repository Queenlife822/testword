...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { data_nascimento: @pessoa.data_nascimento, endereco: @pessoa.endereco, nome: @pessoa.nome, rg: @pessoa.rg, telefone: @pessoa.telefone } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { data_nascimento: @pessoa.data_nascimento, endereco: @pessoa.endereco, nome: @pessoa.nome, rg: @pessoa.rg, telefone: @pessoa.telefone } }
